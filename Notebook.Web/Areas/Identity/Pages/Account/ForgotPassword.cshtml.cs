    ...
    public class ForgotPasswordModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            if (ModelState.IsValid)
            {
                ...
                var sender = new List<EmailAddress> { new EmailAddress { Address = "Notebook", Name = "Notebook" } };
                var reciever = new List<EmailAddress> { new EmailAddress { Address = user.Email, Name = user.Name } };
